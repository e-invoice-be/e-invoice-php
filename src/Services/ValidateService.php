...
final class ValidateService implements ValidateContract
{
     ...
     *     taxCode?: 'AE'|'E'|'S'|'Z'|'G'|'O'|'K'|'L'|'M'|'B'|ValidateValidateJsonParams\Charge\TaxCode|null,
     *     taxRate?: float|string|null,
     *   }>|null,
     ...
     *   invoiceDate?: string|\DateTimeInterface|null,
     ...
     *   serviceEndDate?: string|\DateTimeInterface|null,
     *   serviceStartDate?: string|\DateTimeInterface|null,
     ...
     *   taxCode?: 'AE'|'E'|'S'|'Z'|'G'|'O'|'K'|'L'|'M'|'B'|ValidateValidateJsonParams\TaxCode,

 ...
 *   allowances?: list<Allowance|array{
 ...
 *   charges?: list<Charge|array{
 *     amount?: float|string|null,
 *     base_amount?: float|string|null,
 *     multiplier_factor?: float|string|null,
 *     reason?: string|null,
 *     reason_code?: value-of<\EInvoiceAPI\Validate\ValidateValidateJsonParams\Charge\ReasonCode>|null,
 *     tax_code?: value-of<\EInvoiceAPI\Validate\ValidateValidateJsonParams\Charge\TaxCode>|null,
 *     tax_rate?: float|string|null,
 *   }>|null,
 ...
 *   tax_code?: \EInvoiceAPI\Validate\ValidateValidateJsonParams\TaxCode|value-of<\EInvoiceAPI\Validate\ValidateValidateJsonParams\TaxCode>,
...
final class ValidateValidateJsonParams implements BaseModel
{
     ...
     *
     * @var value-of<ValidateValidateJsonParams\TaxCode>|null $tax_code
     */
    #[Api(
        enum: ValidateValidateJsonParams\TaxCode::class,
        optional: true,
    )]
     ...
     * @param ValidateValidateJsonParams\TaxCode|value-of<ValidateValidateJsonParams\TaxCode> $tax_code
    ...
    public static function with(
        ...
        ValidateValidateJsonParams\TaxCode|string|null $tax_code = null,
     ...
     * Tax category code of the invoice (e.g., S for standard rate, Z for zero rate, E for exempt).
     *
     * @param ValidateValidateJsonParams\TaxCode|value-of<ValidateValidateJsonParams\TaxCode> $taxCode
     */
